...
type PrivateScrapeOptions = ScrapeOptions & {
  readonly storeInCache: false;
  readonly redactPII: true;
};

/** Applies privacy controls shared by scrape options nested in other requests. */
export function privateScrapeOptions(
  options: ScrapeOptions,
): PrivateScrapeOptions {
  return {
    ...options,
    storeInCache: false,
    redactPII: true,
      ...
      runFirecrawl(
        ...
        (client) =>
          crawlEffect(client, params.url, {
            ...
            scrapeOptions: privateScrapeOptions({
              formats: ["markdown"],
